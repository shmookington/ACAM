...
export async function buildProposalPDF(lead, content) {
    ...
    const tiers = [
        { name: content.pricing.starter_name, price: content.pricing.starter_price, tagline: content.pricing.starter_tagline, features: content.features_starter, popular: false },
        { name: content.pricing.pro_name, price: content.pricing.pro_price, tagline: content.pricing.pro_tagline, features: content.features_pro, popular: true },
        { name: content.pricing.premium_name, price: content.pricing.premium_price, tagline: content.pricing.premium_tagline, features: content.features_premium, popular: false },
    ];
